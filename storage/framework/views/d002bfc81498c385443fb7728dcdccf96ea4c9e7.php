    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <table class="table">
                ...
                <tbody>
                <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th scope="row"><?php echo e($product->id); ?></th>
                        <td><?php echo e($product->name); ?></td>
                        <td><?php echo e($product->rollnumber); ?></td>
                        <td><?php echo e($product->email); ?></td>
                        <td><?php echo e($product->phone); ?></td>
                        <td><a href="/update/<?php echo e($product->id); ?>">Edit</a></td>
                        <td><a href="/delete/<?php echo e($product->id); ?>">Delete</a></td>
                    </tr>
